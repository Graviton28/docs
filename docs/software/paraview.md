---
title: "ParaView remote visualization"
description: "Run the ParaView server on CARC compute nodes and connect from your desktop client."
type: Guide
tags:
  - Visualization
  - ParaView
...
sources:
  - id: quickbytes
    resource: "https://github.com/UNM-CARC/QuickBytes/blob/master/paraview.md"
    title: "UNM-CARC QuickBytes: paraview.md"
    author: "team:unm-carc"
    last_modified: "2024-06-09T01:00:00-06:00"
---
...
These steps will help you setup Paraview to work as a client/server mode, being your laptop/desktop computer a client and the cluster a server. Be sure that the ParaView version installed on your local computer matches the same one that is installed on the CARC clusters.
...
![](../assets/images/quickbytes/paraview-img1.png)
...
![](../assets/images/quickbytes/paraview-img2.png)
...
![](../assets/images/quickbytes/paraview-img3.png)
