---
title: "Demographic inference with PSMC"
description: "Infer population size history from diploid genomes using PSMC."
type: Tutorial
tags:
  - Bioinformatics
  - Population genetics
...
sources:
  - id: quickbytes
    resource: "https://github.com/UNM-CARC/QuickBytes/blob/master/psmc_quickbyte.md"
    title: "UNM-CARC QuickBytes: psmc_quickbyte.md"
    author: "team:unm-carc"
    last_modified: "2021-08-16T10:52:42-06:00"
---
...
<p class="carc-provenance" markdown>Migrated from [UNM-CARC QuickBytes](https://github.com/UNM-CARC/QuickBytes/blob/master/psmc_quickbyte.md){target=_blank} (last source update 2021-08-16). Spotted a problem? [Open an issue or pull request](https://github.com/UNM-CARC/QuickBytes){target=_blank}.</p>
